                                                ...
                                                if suma_porcentajes > 100:
                                                    ...
                                                    if bandera_tipo_cruce != "--tipo-cruce":
                                                        ...
                                                        if valor_tipo_cruce != 0 and valor_tipo_cruce != 1:
                                                            ...
                                                            #algoritmo_genetico(archivo_txt, valor_direccion, cantidad_individuos, cantidad_generaciones, valor_bandera_agregar, valor_bandera_cambiar, valor_bandera_eliminar, valor_tipo_cruce)
